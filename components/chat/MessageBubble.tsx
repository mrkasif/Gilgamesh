  ...
  if (isUser) {
    return (
      <div className="flex justify-end">
        <div className="message-in max-w-[85%] rounded-2xl border border-accent/15 bg-accent/[0.07] px-4 py-2.5 text-[15px] leading-6 whitespace-pre-wrap text-foreground sm:max-w-[70%]">
          {message.content}
        </div>
      </div>
    );
